            ...
            <div className={'project_add fz0'}>
                <div className={`item item1 dib `} >
                    <div className={'padd fz0 cp'} onClick={()=>{history.push('/blindbox')}}>
                        ...
                        <h3 className={'dib'}>{pathname == '/blindbox/edit' ? '编辑盲盒' : '发行盲盒'}</h3>
                    </div>
                </div>
                    ...
                    <div className={'padd'}>
                        <div className={'row'}>
                            ...
                            <div className={'tablist_add fz0'}>
                                <ul>
                                    <li className={` ${pathname == '/blindbox/add' ? 'active' : ''} `} onClick={()=>{history.push('/blindbox/add')}}>基础型</li>
                                    <li className={` ${pathname == '/blindbox/add/advance' ? 'active' : ''} `} onClick={()=>{history.push('/blindbox/add/advance')}}>进阶型</li>
                                </ul>
                            </div>
                            ...
                            <div className={'row'}>
                                <div className={'attr'}>
                                    ...
                                    <div className={'attr_but fz0'}>
                                        <button className={'dib button_def1 mr10 mb10'} onClick={()=>{addPrimeAttr()}}><span style={{fontSize: 12}}><PlusOutlined /></span>添加属性值</button>
